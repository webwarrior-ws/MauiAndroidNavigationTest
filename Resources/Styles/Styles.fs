...
NOTE ABOUT THIS FILE:
   ...
   the styles are stored using resource ids (MauiAndroidNavigationTest.Resources.Styles.XXX.xaml) so Maui uses XamlResourceId
   ...
   - Add a class name inside the XAML (<ResourceDictionary x:Class="MauiAndroidNavigationTest.Maui.XXX">)
   - Create a new type in this file:
    ...
    - Register the XAML file and this type by adding a XamlResourceId attribute below
        - ResourceId must follow format: Namespace.Folder.SubFolder.FileName.Extension (MauiAndroidNavigationTest.Resources.Styles.XXX.xaml)
...
[<XamlResourceId("MauiAndroidNavigationTest.Resources.Styles.Colors.xaml", "Resources/Styles/Colors.xaml", typeof<Colors>)>]
[<XamlResourceId("MauiAndroidNavigationTest.Resources.Styles.Styles.xaml", "Resources/Styles/Styles.xaml", typeof<Styles>)>]
do ()
